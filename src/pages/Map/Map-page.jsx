...
import {
  ...
  handleSaveHistoryPresenter,
} from "../../../presenters/map-presenter";
import {
  FaLocationDot,
  FaCircleInfo,
  FaWaveSquare,
      ...
      <div className="w-full max-w-screen-xl mx-auto pb-1">
        <div className="flex flex-col md:flex-row flex-1 p-4 gap-4 mt-[100px]">
          ...
          >
            {/* Form Prediksi */}
            <div
              className="bg-white rounded-sm shadow p-6 space-y-3 text-black font-poppins"
            ...
            {prediction && (
              <div
                className="bg-white text-black p-6 rounded-sm shadow mt-6 space-y-4 text-sm overflow-auto max-h-[500px] items-center"
                style={{ boxShadow: " inset 8px 4px 4px rgba(0, 0, 0, 0.5)" }}
              >
                <h3 className="text-lg sm:text-xl md:text-xl font-semibold mb-4 font-poppins text-center">
                  Informasi Prediksi
                </h3>
                {prediction ? (
                  <>
                    <div className="text-black font-poppins text-xs sm:text-sm md:text-lg space-y-3">
                      ...
                      <div className="flex justify-center mt-4 ">
                        <button
                          onClick={() =>
                            handleSaveHistoryPresenter(prediction, navigate)
                          }
                  ...
                  <p className="text-center text-white text-base">
                    Silakan pilih lokasi dan klik tombol "Prediksi" untuk
                    melihat hasil prediksi bencana.
                  </p>
                )}
              </div>
            )}
